...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                <span class="navbar-text col text-center">Welcome!!</span>
                <form class="d-flex">
    ...
    <div class="container-fluid mb-5">
        <p class="h1 mt-2">Hotel Manangement System </p>
        <p class="mt-2">Search Guest Here</p>
        <div class="card mt-2">
        ...
        <div class="card-footer">This are all the List of Guest</div>
    </div>
